...
const socks: OrderItem = new OrderItem('Socks', 'Christmas Socks', { amount: 10, currency: 'EUR' }, 0.2, 'unit', 2)

const bag: OrderItem = new OrderItem('Bag', '', { amount: 45, currency: 'EUR' }, 0.1, 'unit', 1)
